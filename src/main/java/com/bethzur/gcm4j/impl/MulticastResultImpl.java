 ...
 */
public final class MulticastResultImpl implements MulticastResult {
    ...
    static final class Builder {
        ...
        public MulticastResultImpl build() {
            return new MulticastResultImpl(this);
        }
    }

    private MulticastResultImpl(Builder builder) {
